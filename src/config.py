...
CONFIG = {
    ...
    "instruction_types": [
        ...
        (
            "generate_question",
            "Generate a thought-provoking question about this concept:",
        ),
        (
            "provide_example",
            "Provide a real-world example that illustrates this concept:",
        ),
        (
            "learning_path",
            "Suggest a learning path to master this concept, including prerequisite topics and follow-up areas:",
        ),
        ...
        (
            "quiz_generation",
            "Generate a multiple-choice quiz question about this concept, including the correct answer and three plausible distractors:",
        ),
        (
            "concept_relation",
            "Explain how this concept relates to another relevant concept in the field:",
        ),
        ("application", "Describe a practical application or use case for this concept:"),
        (
            "difficulty_assessment",
            "Assess the difficulty level of this concept and explain why it might be challenging for some students:",
        ),
    ],
}
